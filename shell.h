...
/**
 * struct passinfo - contains prototype for function pointer struct
 * @arg: from getline containing arguements
 * @argv:generated from arg
 * @path: for the current command
 * @argc: argument count
 * @line_count: error count
 * @err_num: code for exit()s
